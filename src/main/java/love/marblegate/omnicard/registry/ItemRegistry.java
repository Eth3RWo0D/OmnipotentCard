...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> FIELD_CARD = ITEMS.register("field_card", () -> new PlaceableSpecialCard(SpecialCardType.FIELD));
    public static final RegistryObject<Item> PURIFICATION_CARD = ITEMS.register("purification_card", () -> new PlaceableSpecialCard(SpecialCardType.PURIFICATION));
    public static final RegistryObject<Item> SEAL_CARD = ITEMS.register("seal_card", () -> new PlaceableSpecialCard(SpecialCardType.SEAL));
    public static final RegistryObject<Item> SUNNY_CARD = ITEMS.register("sunny_card", () -> new PlaceableSpecialCard(SpecialCardType.SUNNY));
    public static final RegistryObject<Item> RAINY_CARD = ITEMS.register("rainy_card", () -> new PlaceableSpecialCard(SpecialCardType.RAINY));
    public static final RegistryObject<Item> THUNDERSTORM_CARD = ITEMS.register("thunderstorm_card", () -> new PlaceableSpecialCard(SpecialCardType.THUNDERSTORM));
    public static final RegistryObject<Item> BLOOM_CARD = ITEMS.register("bloom_card", () -> new PlaceableSpecialCard(SpecialCardType.BLOOM));
