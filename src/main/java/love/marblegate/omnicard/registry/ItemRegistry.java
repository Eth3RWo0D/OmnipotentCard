...
import love.marblegate.omnicard.item.SpecialCard;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> FIELD_CARD = ITEMS.register("field_card", ()->new SpecialCard(CardType.FIELD));
    public static final RegistryObject<Item> PURIFICATION_CARD = ITEMS.register("purification_card", ()->new SpecialCard(CardType.PURIFICATION));
    public static final RegistryObject<Item> SEAL_CARD = ITEMS.register("seal_card", ()->new SpecialCard(CardType.SEAL));
    public static final RegistryObject<Item> SUNNY_CARD = ITEMS.register("sunny_card", ()->new SpecialCard(CardType.SUNNY));
    public static final RegistryObject<Item> RAINY_CARD = ITEMS.register("rainy_card", ()->new SpecialCard(CardType.RAINY));
    public static final RegistryObject<Item> THUNDERSTORM_CARD = ITEMS.register("thunderstorm_card", ()->new SpecialCard(CardType.THUNDERSTORM));
    public static final RegistryObject<Item> BLOOM_CARD = ITEMS.register("bloom_card", ()->new SpecialCard(CardType.BLOOM));
