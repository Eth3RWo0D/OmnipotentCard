...
public class CommonCards {
    ...
    public static CommonCard BLANK = register(new CommonCard.Builder("white_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::whiteCard), (byte) 0);
    public static CommonCard RED = register(new CommonCard.Builder("red_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::redCard), (byte) 1);
    public static CommonCard CORAL = register(new CommonCard.Builder("orange_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::orangeCard), (byte) 2);
    public static CommonCard GOLD = register(new CommonCard.Builder("gold_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::goldCard), (byte) 3);
    public static CommonCard SEA_GREEN = register(new CommonCard.Builder("green_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::greenCard), (byte) 4);
    public static CommonCard AZURE = register(new CommonCard.Builder("sky_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::skyCard), (byte) 5);
    public static CommonCard CERULEAN_BLUE = register(new CommonCard.Builder("blue_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::blueCard), (byte) 6);
    public static CommonCard HELIOTROPE = register(new CommonCard.Builder("violet_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::violetCard), (byte) 7);
    public static CommonCard INK = register(new CommonCard.Builder("black_card", STANDARD_CATE).setRetrievedItem(ItemRegistry.BLANK_CARD).setFlyCardHitHandler(CardFunc.FlyingCard::blackCard), (byte) 8);
