...
public class BlockCards {
    ...
    public static BlockCard SEAL = register(new BlockCard.Builder("seal_card", SPECIAL_CATE, -1).setRetrievedItem(ItemRegistry.SEAL_CARD).isRetrievableWhenBreak().setClientTickHandler(CardFunc.BlockCard::sealCardClient), (byte) 2);
    ...
    public static BlockCard BLOOM = register(new BlockCard.Builder("bloom_card", SPECIAL_CATE, -1).setRetrievedItem(ItemRegistry.FIELD_CARD).setServerTickHandler(CardFunc.BlockCard::bloomCard).isRetrievableWhenBreak(), (byte) 6);
